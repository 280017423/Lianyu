...
import com.xhr.framework.imageloader.cache.disc.DiscCacheAware;
import com.xhr.framework.imageloader.cache.disc.impl.FileCountLimitedDiscCache;
import com.xhr.framework.imageloader.cache.disc.impl.TotalSizeLimitedDiscCache;
import com.xhr.framework.imageloader.cache.disc.impl.UnlimitedDiscCache;
import com.xhr.framework.imageloader.cache.disc.naming.FileNameGenerator;
import com.xhr.framework.imageloader.cache.disc.naming.HashCodeFileNameGenerator;
import com.xhr.framework.imageloader.cache.memory.MemoryCacheAware;
import com.xhr.framework.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.xhr.framework.imageloader.cache.memory.impl.UsingFreqLimitedMemoryCache;
import com.xhr.framework.imageloader.core.assist.MemoryCacheKeyUtil;
...
import com.xhr.framework.imageloader.core.download.ImageDownloader;
import com.xhr.framework.imageloader.core.download.URLConnectionImageDownloader;
import com.xhr.framework.imageloader.utils.StorageUtils;
