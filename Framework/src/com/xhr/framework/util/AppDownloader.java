...
public class AppDownloader {
	...
	public void download(final AppInfo appInfo, final double size, final boolean isUpgradeMust) {
		...
		if (isDownloading()) {
			Toast.makeText(XhrApplicationBase.CONTEXT, R.string.more_apps_is_downloading, Toast.LENGTH_SHORT).show();
		} else {
				...
				public void run() {
					...
					try {
						...
						String message = mContext.getResources().getString(
								...
								+ e.getMessage();
						Looper.prepare();
						Toast.makeText(XhrApplicationBase.CONTEXT, message, Toast.LENGTH_SHORT).show();
						Looper.loop();
						EvtLog.e(TAG, e);
					} finally {
						ISDOWNLOADING = false;
