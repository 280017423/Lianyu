...
public class CrashHandler implements UncaughtExceptionHandler {
	...
	private String mCrashPath = Environment.getExternalStorageDirectory().getPath() + File.separator
			+ "qianjiang/crash/" + PackageUtil.getPackageName() + "/";
		...
		if (ex != null) {
			...
			try {
				...
				logContent.put("Message",
						StringUtil.htmEncode(XhrApplicationBase.getInstance().getClientInfo() + "||" + ex.toString()));
