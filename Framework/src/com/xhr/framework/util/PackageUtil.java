...
public class PackageUtil {
	...
	public static String getPackageName() {
		return XhrApplicationBase.CONTEXT.getPackageName();
	}
	...
	public static int getVersionCode() throws NameNotFoundException {
		int verCode = XhrApplicationBase.CONTEXT.getPackageManager().getPackageInfo(
				XhrApplicationBase.CONTEXT.getPackageName(), 0).versionCode;
		return verCode;
	}
	...
	public static String getVersionName() throws NameNotFoundException {
		String versionName = XhrApplicationBase.CONTEXT.getPackageManager().getPackageInfo(
				XhrApplicationBase.CONTEXT.getPackageName(), 0).versionName;
	...
	public static String getLocalMacAddress() {
		WifiManager wifi = (WifiManager) XhrApplicationBase.CONTEXT.getSystemService(Context.WIFI_SERVICE);
	...
	public static String getString(int resourceId) {
		Resources res = XhrApplicationBase.CONTEXT.getResources();
	...
	public static String getTerminalSign() {
		...
		TelephonyManager tm = (TelephonyManager) XhrApplicationBase.CONTEXT.getSystemService(Context.TELEPHONY_SERVICE);
	...
	public static String getDeviceId() {
		...
		deviceId = ((TelephonyManager) XhrApplicationBase.CONTEXT.getSystemService(Context.TELEPHONY_SERVICE))
				.getDeviceId();
		if (StringUtil.isNullOrEmpty(deviceId)) {
			deviceId = Secure.getString(XhrApplicationBase.CONTEXT.getContentResolver(), Secure.ANDROID_ID);
		}
		return deviceId;
	}
	...
	public static String getConfigString(String key) {
		String val = "";
		try {
			ApplicationInfo appInfo = XhrApplicationBase.CONTEXT.getPackageManager().getApplicationInfo(
					XhrApplicationBase.CONTEXT.getPackageName(), PackageManager.GET_META_DATA);
