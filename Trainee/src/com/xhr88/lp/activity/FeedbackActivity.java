 ...
 * @author zou.sq
 */
public class FeedbackActivity extends TraineeBaseActivity implements OnClickListener {
    ...
    private void initViews() {
        ...
        mGvAddImg.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(FeedbackActivity.this, PhotoPreviewActivity.class);
    ...
    private void showPickPop() {
        ...
        btnPickPhoto.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                popManager.dismiss();
                Intent intent = new Intent(FeedbackActivity.this, ImageAlbumActivity.class);
    ...
    private void submit(final String imageUrl) {
        ...
        new ActionProcessor().startAction(FeedbackActivity.this, true, true, new IActionListener() {
            ...
            public ActionResult onAsyncRun() {
                ...
                return SystemReq.feedBack("2", "", content, imageUrl);
            }
        });
    }
