...
public class OtherTrendsListAdapter extends BaseAdapter {
	...
	public OtherTrendsListAdapter(Activity activity, List<OtherSubTrendsModel> dataModel, ImageLoader loader,
	...
	@Override
	public OtherSubTrendsModel getItem(int position) {
		if (mDynamicListModels != null && !mDynamicListModels.isEmpty()) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final OtherSubTrendsModel model = getItem(position);
		try {
