...
package com.xhr88.lp.widget.wheelview;
...
import com.xhr88.lp.widget.wheelview.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_text_item_bg);
		}
		...
		setBackgroundColor(Color.WHITE); // 改变WheelView的背景颜色为白色
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		// drawShadows(canvas); // 设置wheelView的边框阴影
	}
	...
	private void drawCenterRect(Canvas canvas) {
		...
		int offset = (int) (getItemHeight() / 2); // 计算阴影的高度
